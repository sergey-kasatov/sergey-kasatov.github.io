...
| `p-carprice.webp` | card | `https://github.com/sergey-kasatov/car-price-estimator` `reports/figures/09_interval_coverage.png` | 1260x630 | none | 960x600 | 15 KB, q85 | repository figure: interval coverage per price band, one global multiplier vs calibrated per band |
